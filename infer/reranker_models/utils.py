...
try:
    ...
    def _missing_torch_transformers(*_args, **_kwargs):
        raise ImportError("torch and transformers are required for reranker model loading")

    def get_dtype(*args, **kwargs):
        return _missing_torch_transformers(*args, **kwargs)
